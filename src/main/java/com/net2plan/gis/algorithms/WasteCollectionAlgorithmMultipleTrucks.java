...
public class WasteCollectionAlgorithmMultipleTrucks implements IAlgorithm 
{
	...
	private InputParameter numberOfRuns = new InputParameter ("numberOfRuns", (int) 100 , "The number of runs of this algorithm to be produced" , 1 , Integer.MAX_VALUE);
	...
	public String executeAlgorithm(NetPlan netPlan, Map<String, String> algorithmParameters, Map<String, String> net2planParameters) 
	{
		...
		final File folder = new File (nameOfOutputFolderWithResults.getString()+"_"+ minPercentageToCollect.getDouble());
